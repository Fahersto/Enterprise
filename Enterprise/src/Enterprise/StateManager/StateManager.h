...
public:
	...
	static void PushState(State* newState, bool blockLowerFixed = false, bool blockLowerUpdates = false, bool blockLowerDraws = false);
	...
	static void SwapState(State* newState);
	...
	static bool IsStateOnTop(State* s = nullptr);
