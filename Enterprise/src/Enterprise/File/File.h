...
public:
	...
	static std::string VirtualPathToNative(const std::string& path);
	...
	static ErrorCode SaveTextFile(const std::string& path, const std::string& inString);
