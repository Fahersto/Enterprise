...
public:
	...
	static void DrawSprite(Graphics::TextureHandle texture,
	...
	static void DrawText(std::string text, Graphics::TextureHandle atlas,
	...
	static void DeleteSpriteComponent(EntityID entity);
	...
	static std::vector<EntityID> GetEntitiesWithSpriteComponents();
	...
	static bool SerializeSpriteComponent(EntityID entity, YAML::Node& yamlOut);
	...
	static bool DeserializeSpriteComponent(EntityID entity, const YAML::Node& yamlIn);

	/// Initialize Renderer2D.
	/// @param maxSpriteComponents The maximum number of sprite components to support.
	static void Init(size_t maxSpriteComponents);
